...
public class Dark_Matter_Sword_Recipe {
    public static ShapedRecipe get() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(PluginE.instance,"dark_matter_sword"), Dark_Matter_Sword.get());
