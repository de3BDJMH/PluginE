...
public class Red_Matter_Pickaxe {
    public static ItemStack get() {//所有攻击伤害攻击速度加成都会被集成到攻击事件中，因为写在这里会导致无法合成
        ...
        AttributeModifier am = new AttributeModifier(UUID.randomUUID(),"伤害",8,AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HAND);
        itemMeta.addAttributeModifier(Attribute.GENERIC_ATTACK_DAMAGE,am);
        itemMeta.setDisplayName(ChatColor.YELLOW+"红物质镐");
        itemMeta.setLocalizedName("红物质镐");
